...
* **JUnit 5 & MockMvc:** Pruebas unitarias de controladores.

## 📌 Funcionalidades Implementadas
1. **Endpoint de Salud:** `/api/v1` (GET)
2. **Sistema de Saludos:** `/api/v1/saludos` (GET/POST) con normalización de nombres.
3. **Manejo Global de Excepciones:** Respuestas estructuradas para errores de negocio.
4. **Simulador de Préstamos (Desafío):** `/api/v1/prestamos` (POST) para cálculo de cuotas niveladas.

---
*(Aquí puedes dejar las instrucciones originales del repo si las había, o simplemente un "Instrucciones de ejecución" con `mvn spring-boot:run`)*
